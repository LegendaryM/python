// 参考： https://blog.csdn.net/zhp980121/article/details/129119257
...
Object.prototype.toString = function () {
    ...
    console.log("Object.prototype.toString: " + _temp, " => ", this.constructor.name);
...
"use strict";
// var _type_of = __webpack_require__(74185), // 注意这个地方 _type_of的替换
var test = "1",
aaa = function (tt) {
...
function o(tt) {
    return (o = "function" == typeof Symbol && "symbol" == aaa(Symbol.A) ? function (tt) {
        return void 0 === tt ? "undefined" : aaa(tt)
    }
         : function (tt) {
        return tt && "function" == typeof Symbol && tt.constructor === Symbol && tt !== Symbol.prototype ? "symbol" : void 0 === tt ? "undefined" : aaa(tt)
    })(tt)
}
...
console.log('运行值:', D('763f8681182ae6c0230f3dd9720e6599'))
// console.log('正常值:VuKS8jFrfCANkr7IqZQmokbAgv5ITT/+jJvbAqOAHfU+FB4mF+O57IPXHpD1ODGd');