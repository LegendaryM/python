...
def word2vec_basic(log_dir):
  """Example of building, training and visualizing a word2vec models."""
  ...
  # Step 3: Function to generate a training batch for the skip-gram models.
  ...
  # Step 4: Build and train a skip-gram models.
  ...
  # displaying models accuracy, they don't affect calculation.
  ...
  with tf.compat.v1.Session(graph=graph) as session:
    ...
    # Save the models for checkpoints.
    saver.save(session, os.path.join(log_dir, 'models.ckpt'))
